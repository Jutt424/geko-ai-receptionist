...
const buildRestaurantTools = ({ baseUrl, secret }) => ([
  ...
  },
  {
    type: "custom",
    name: "update_order",
    description: "Update an order (status, items, or delivery details)",
    url: `${baseUrl}/retell/functions/update_order`,
    method: "POST",
    parameter_type: "json",
    args_at_root: false,
    headers: { "x-retell-secret": secret },
    speak_during_execution: true,
    execution_message_description: "Updating that order now.",
    speak_after_execution: true,
    timeout_ms: 120000,
    parameters: {
      type: "object",
  ...
  },
  {
    type: "custom",
    name: "cancel_order",
    description: "Cancel an order by id or customer phone",
    url: `${baseUrl}/retell/functions/cancel_order`,
    method: "POST",
    parameter_type: "json",
    args_at_root: false,
    headers: { "x-retell-secret": secret },
    speak_during_execution: true,
    execution_message_description: "Cancelling that order now.",
    speak_after_execution: true,
    timeout_ms: 120000,
    parameters: {
      type: "object",
